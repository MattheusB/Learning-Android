package com.cursoandroid.signs.signs;
...
public class MainActivity extends Activity {
    ...
    private String[] signs = {"Áries", "Touro", "Gêmeos", "Câncer", "Leão", "Virgem", "Libra", "Escorpião", "Sargitário",
    "Capriocórnio", "Aquário", "Peixes"};

    private String[] description = {"Impulsivo, o ariano não pensa muito sobre seus atos. É aquele que primeiro age, depois reflete. Agitado, precisa de muita atividade para gastar a energia, senão pode ficar agressivo e explosivo.",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signsList = findViewById(R.id.listViewID);

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1,
        android.R.id.text1, signs);
